---
layout: post
title: 【pwn4kernel】Kernel ret2dir技术分析
...
在**ret2dir**技术中，当利用内存喷射（Spraying）将利用载荷（shellcode或ROP链）大量“喷洒”到物理内存后，面临一个关键问题：我们无法精确控制内核执行流最终会跳转到喷射页面的哪个具体偏移地址。为了确保无论内核从页面的哪个位置开始执行，都能“滑行”到预先设定好的、有效的ROP链起点，需要构造一种具备“滑动”能力的ROP布局。
